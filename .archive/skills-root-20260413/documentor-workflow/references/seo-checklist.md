...
> [!IMPORTANT]
> H1 uses **sentence case** while title uses **title case**. This is a common mistake ΓÇö subheadings also use sentence case.
...
| Hierarchy | No skipped levels (H2 ΓåÆ H3 ΓåÆ H4) |
