...
- **Internal links**: Use relative paths ΓÇö `[Link text](other-article.md)`
...
- **H2**: Main sections ΓÇö use sentence-style capitalization
- **H3**: Subsections under H2 ΓÇö sentence-style capitalization
