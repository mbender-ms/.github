...
```markdown
---
title: <Verb + noun ΓÇö 30-65 chars, title case>
description: <"Learn how to..." ΓÇö 120-165 chars>
...
<Intro paragraph ΓÇö 1-3 sentences. "In this article, you learn how to [task] using [service].">
...
## <First task section ΓÇö imperative verb>

<Brief context for this task ΓÇö 1-2 sentences.>

1. <Step ΓÇö imperative verb, max 7 steps per section>
1. <Step>
1. <Step>
...
```markdown
---
title: <Noun phrase ΓÇö 30-65 chars, title case>
description: <"Learn about..." ΓÇö 120-165 chars>
author: <GitHub username>
ms.author: <Microsoft alias>
ms.service: <azure-service-name>
...
<Intro paragraph ΓÇö "X is a Y that does Z." Explain what the technology is and why it matters.>
...
```markdown
---
title: "Quickstart: <Verb + noun ΓÇö 30-65 chars, title case>"
description: <"In this quickstart, you..." ΓÇö 120-165 chars>
author: <GitHub username>
ms.author: <Microsoft alias>
ms.service: <azure-service-name>
ms.topic: quickstart
...
<Intro ΓÇö 1-2 sentences. What the user accomplishes and why it matters.>
...
## <Main task ΓÇö single focused goal>
...
```markdown
---
title: "Tutorial: <Verb + noun ΓÇö 30-65 chars, title case>"
description: <"In this tutorial, you learn how to..." ΓÇö 120-165 chars>
author: <GitHub username>
ms.author: <Microsoft alias>
ms.service: <azure-service-name>
ms.topic: tutorial
...
<Intro ΓÇö what the user builds or learns. List what they'll do:>
...
## <Step 1 heading ΓÇö progressive build>
...
description: <"Learn about <product>..." ΓÇö 120-165 chars>
author: <GitHub username>
ms.author: <Microsoft alias>
ms.service: <azure-service-name>
ms.topic: overview
...
<Paragraph 1 ΓÇö Brief product info: what it is, who it's for, core value proposition.>

<Paragraph 2 ΓÇö New capabilities or unique differentiators.>

<Paragraph 3 ΓÇö Point readers to related documentation and Learn modules.>

## Key features

- **<Feature>** ΓÇö <Brief description>
- **<Feature>** ΓÇö <Brief description>
- **<Feature>** ΓÇö <Brief description>
