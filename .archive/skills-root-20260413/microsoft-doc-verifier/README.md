...
A VS Code Copilot skill that fact-checks Microsoft documentation against official sources across **all product areas** ΓÇö Azure, Microsoft 365, Microsoft Security, Power Platform, Dynamics 365, Windows, Developer Tools, and more.
...
| **GitHub Copilot extension** | Extensions panel ΓåÆ search "GitHub Copilot" ΓåÆ must show installed and signed in |
| **GitHub Copilot Chat** | Extensions panel ΓåÆ search "GitHub Copilot Chat" ΓåÆ must show installed |
| **Agent mode enabled** | Copilot Chat ΓåÆ click the mode dropdown ΓåÆ "Agent" should be available |
...
Γö£ΓöÇΓöÇ SKILL.md                          # Skill definition (Copilot reads this)
Γö£ΓöÇΓöÇ README.md                         # This file
ΓööΓöÇΓöÇ assets/
    Γö£ΓöÇΓöÇ single-article-check.prompt.md   # Workflow 1: Single article
    Γö£ΓöÇΓöÇ batch-report.prompt.md           # Workflow 2: Batch report
    Γö£ΓöÇΓöÇ pr-review.prompt.md              # Workflow 3: PR review
    ΓööΓöÇΓöÇ research-only.prompt.md          # Workflow 4: Research
```
...
### Example 1 ΓÇö Fact-check a single article
...
### Example 3 ΓÇö Fact-check a folder of M365 Security docs
...
### Example 4 ΓÇö Research a topic

**You**: "Research Microsoft Purview sensitivity labels ΓÇö what are the current capabilities and limits?"
...
Γöé  You describe what to verify                 Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
               Γöé
               Γû╝
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé  Step 0: Scope the verification              Γöé
Γöé  ΓÇó Product area (Azure, M365, Security, ...) Γöé
Γöé  ΓÇó Service/feature focus                     Γöé
Γöé  ΓÇó Single file, folder, or PR?               Γöé
Γöé  ΓÇó Output preference                         Γöé
Γöé  ΓÇó Depth (quick or thorough)                 Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
               Γöé
               Γû╝
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé  Step 1: Extract claims                      Γöé
Γöé  ΓÇó Product names, features, limits           Γöé
Γöé  ΓÇó CLI/API commands, code examples           Γöé
Γöé  ΓÇó SKU requirements, pricing, availability   Γöé
Γöé  ΓÇó Preview/GA/deprecated status              Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
               Γöé
               Γû╝
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé  Step 2: Verify against sources              Γöé
Γöé  ΓÇó Tier 1: learn.microsoft.com (primary)     Γöé
Γöé  ΓÇó Tier 2: techcommunity, devblogs, GitHub   Γöé
Γöé  ΓÇó Tier 3: developer.microsoft.com           Γöé
Γöé  ΓÇó Tier 4: MS Q&A, Stack Overflow (MS only)  Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
               Γöé
               Γû╝
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé  Step 3: Classify each claim                 Γöé
Γöé  Γ£à Accurate     ΓÜá∩╕Å Partially accurate       Γöé
Γöé  Γ¥î Inaccurate   ≡ƒòÉ Outdated                 Γöé
Γöé  Γ¥ô Unverifiable  ≡ƒöù Broken link             Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
               Γöé
               Γû╝
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé  Step 4: Output                              Γöé
Γöé  ΓÇó In-place edits (Workflow 1)               Γöé
Γöé  ΓÇó Standalone report (Workflows 2 & 3)       Γöé
Γöé  ΓÇó Research report (Workflow 4)              Γöé
...
| Icon | Status | Meaning |
|------|--------|---------|
| Γ£à | Accurate | Matches current official documentation |
| ΓÜá∩╕Å | Partially accurate | Mostly correct but needs minor update or missing context |
| Γ¥î | Inaccurate | Contradicts official sources |
| ≡ƒòÉ | Outdated | Was correct but has been superseded |
| Γ¥ô | Unverifiable | No authoritative source found (flagged, not removed) |
| ≡ƒöù | Broken link | URL doesn't resolve or anchor is missing |
