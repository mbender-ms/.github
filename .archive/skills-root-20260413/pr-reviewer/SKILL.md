...
### Contractions
- Line {N}: "cannot" ΓåÆ "can't" (Use contractions for conversational tone)
- Line {N}: "do not" ΓåÆ "don't" (Use contractions for conversational tone)

### Passive Voice
- Line {N}: "is implemented" ΓåÆ Consider "[subject] implements..." (Active voice preferred) ΓÜÖ∩╕Å Agent rewrite recommended
- Line {N}: "is required" ΓåÆ Consider "you must" or "requires" (Active voice preferred)

### Word Choice
- Line {N}: "utilize" ΓåÆ "use" (Simpler alternative)

### Future Tense
- Line {N}: "will create" ΓåÆ "creates" (Use present tense)

### Sentence Structure
- Line {N}: "When configuring" ΓåÆ "When you configure" (Second person + active voice)

### Code Formatting
- Line {N}: `getData()` in prose ΓåÆ Remove parentheses outside code blocks

### Metadata
- Line {N}: "## See Also" ΓåÆ "## Related content"
```
