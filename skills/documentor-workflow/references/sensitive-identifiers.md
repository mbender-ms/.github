# Sensitive Identifiers ΓÇö Approved Replacement Values
...
### Certificate Thumbprint / Hash ΓÇö SEV 0
...
|---|---|---|
| SEV 0 | Secret value ΓÇö immediate exposure risk | Block publication until replaced |
| SEV 1 | Identifying GUID ΓÇö can be used to target resources | Must be replaced before publication |
| SEV 2 | Low-risk identifier ΓÇö limited exposure | Should be replaced; may pass review with justification |
