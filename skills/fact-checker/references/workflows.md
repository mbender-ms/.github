# Fact-Checker Workflows ΓÇö Detailed Reference
...
### Key Features
- 6-tier hierarchy: Tiers 1ΓÇô3 public + Tier 4 Internal Docs + Tier 5 Internal Code + Tier 6 Internal Metadata
...
- Report has two sections: Public Findings + Γ¢ö Internal Findings (Microsoft Confidential)

### Procedure
1. Identify all verifiable claims
2. Verify against public sources (Tiers 1ΓÇô3)
3. Verify against internal sources (Tiers 4ΓÇô6)
...
### When to Use
- Article may be stale ΓÇö need both freshness and accuracy check
...
### Procedure
1. Claim Identification ΓÇö extract all verifiable claims
2. Primary Source Verification ΓÇö search and fetch Tier 1 sources
3. Cross-Reference ΓÇö validate against Tier 2 and 3 sources
4. Technical Accuracy Assessment ΓÇö classify each claim
5. Recommendation Output ΓÇö per-fact structured findings
...
3. Go deep ΓÇö fetch full pages for key sources
...
- Optional Γ¢ö Internal Findings section
...
1. **Executive Summary** ΓÇö scope, period, methodology
2. **Incident Distribution by Service** ΓÇö table with counts and percentages
3. **Trends & Patterns** ΓÇö temporal analysis, seasonal patterns
4. **Top Issue Categories** ΓÇö 6ΓÇô8 ranked categories with counts
5. **Service-Specific Pain Points** ΓÇö per-service subsections
6. **Documentation & Content Opportunities** ΓÇö Priority 1 (quick wins) and Priority 2 (strategic)
7. **Trending Issues** ΓÇö emerging patterns in last 30/60/90 days
8. **Recommendations** ΓÇö prioritized by quarter (Q1 immediate, Q2 medium-term, Q3+ long-term)
9. **Success Metrics** ΓÇö table with metrics, current baseline, targets, measurement method
10. **Data Sources & Methodology** ΓÇö sources used, analysis methods
11. **Conclusion & Action Items** ΓÇö top 3 priorities
...
|---------|----------|-----------|-------------|----------|---------|-------------|--------|
| Edits file | Γ£à | Γ£à | Γ£à (public) | Γ£à | Γ£à | Γ¥î | Γ¥î |
| Report file | Γ¥î | Γ£à | Γ£à | Γ¥î | Γ¥î | Optional | Γ£à |
| Internal sources | Γ¥î | Γ¥î | Γ£à | Γ¥î | Γ¥î | Γ£à | Γ£à |
| Freshness check | Γ¥î | Γ¥î | Γ¥î | Γ£à | Γ¥î | Γ¥î | Γ¥î |
| INCLUDE resolution | Γ£à | Γ¥î | Γ¥î | Γ¥î | Γ¥î | Γ¥î | Γ¥î |
| Per-fact evidence | Γ¥î | Γ£à | Γ£à | Γ¥î | Γ£à | Γ£à | N/A |
| PR workflow | Γ¥î | Γ¥î | Γ¥î | Γ£à | Γ¥î | Γ¥î | Γ¥î |
