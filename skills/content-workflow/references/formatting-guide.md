...
- Γ£à ALWAYS use `"format": "Markdown"` for Description and AcceptanceCriteria
- Γ£à ALWAYS use `"format": "markdown"` for comments
- Γ¥î NEVER use HTML format
- Γ¥î NEVER omit the format parameter
...
```markdown
## Problem / Impact
[Customer-facing problem description ΓÇö what is broken, outdated, or missing]

## Solution
[How you're solving it ΓÇö what content changes are being made]
...
```markdown
### Success criteria
- [Measurable outcomes ΓÇö e.g., "All CLI examples verified against latest API version"]

### Documentation updates
- [Specific files/sections ΓÇö e.g., "articles/expressroute/quickstart.md: Update prerequisites"]

### Verification
- [How to verify completion ΓÇö e.g., "Build passes, links validated, content reviewed"]
```
...
- Γ£à Use the full GitHub URL: `[PR 12345](https://github.com/MicrosoftDocs/azure-docs-pr/pull/12345)`
- Γ¥î Do NOT use `#12345` ΓÇö ADO interprets `#` followed by a number as a work item reference
