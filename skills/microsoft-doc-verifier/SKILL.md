...
argument-hint: "Describe what to verify ΓÇö e.g., 'fact-check these M365 security articles', 'verify this PR', 'check this folder of Defender docs'"
user-invocable: true
---

# Microsoft Documentation Verifier

Verify technical accuracy of Microsoft documentation across **any product area** ΓÇö Azure, Microsoft 365, Microsoft Security, Power Platform, Dynamics 365, Windows, Developer Tools, and more.
...
- **"Fact-check this article"** ΓåÆ Workflow 1
- **"Fact-check these files / this folder"** ΓåÆ Workflow 2
- **"Fact-check PR #12345"** ΓåÆ Workflow 3
- **"Research topic X with sources"** ΓåÆ Workflow 4

## Step 0 ΓÇö Scope the verification (REQUIRED)
...
### Tier 1 ΓÇö Primary official documentation
...
### Tier 2 ΓÇö Secondary official sources
...
### Tier 3 ΓÇö Tertiary official sources
...
### Tier 4 ΓÇö Community (verified Microsoft only)
...
| ΓÜá∩╕Å Partially accurate | Minor discrepancy or missing context | Flag with recommendation |
| Γ¥î Inaccurate | Contradicts official source | Flag with correction + source |
| ≡ƒòÉ Outdated | Was correct but superseded | Flag with current info + source |
| Γ¥ô Unverifiable | No authoritative source found | Flag ΓÇö do not remove |

### Step 4 ΓÇö Generate output
...
|--------|-------|-------------|
| Γ£à Accurate | N | Claims match official documentation |
| ΓÜá∩╕Å Partially accurate | N | Minor discrepancy or missing context |
| Γ¥î Inaccurate | N | Contradicts official sources |
| ≡ƒöù Broken/suspect link | N | Links that may not resolve |

---

## Critical findings (action required)

### 1. [Severity icon] [File] ΓÇö [Brief description]
**Claim**: "[quoted text]"
...
|------|-------|--------|-------|
| file.md | Description | Γ£à/ΓÜá∩╕Å/Γ¥î | Details |
...
| Link | Status |
|------|--------|
| `/path/to/doc` | Γ£à Valid / ≡ƒöù Suspect |
