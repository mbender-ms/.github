...
| Azure DNS | `azure-dns` | 108 |
| Azure ExpressRoute | `azure-expressroute` | 161 |
| Azure Firewall | `azure-firewall` | 197 |
| Azure Front Door | `azure-front-door` | 157 |
| Load Balancer | `azure-load-balancer` | 230 |
| NAT Gateway | `azure-nat-gateway` | 495 |
| Network Watcher | `azure-network-watcher` | 284 |
| Private Link | `azure-private-link` | 451 |
| Traffic Manager | `azure-traffic-manager` | 136 |
| Virtual Network | `azure-virtual-network` | 75 |
| VPN Gateway | `azure-vpn-gateway` | 163 |
| Web Application Firewall | `azure-web-application-firewall` | 410 |
...
| App Service | `azure-app-service` | 72 |
