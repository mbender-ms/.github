...
**context-mode ΓÇö fetch and index web sources without flooding context:**
```
...
**xh ΓÇö structured HTTP requests for any API sources:**
```bash
...
1. **learn.microsoft.com** ΓÇö Official docs, troubleshooting guides, known issues, service limits
2. **azure.microsoft.com** ΓÇö Service pages, SLAs, status history, update announcements
3. **techcommunity.microsoft.com** ΓÇö Official blog posts, incident retrospectives, best practices
4. **devblogs.microsoft.com** ΓÇö Engineering team blogs, postmortems, feature announcements
5. **github.com/microsoft** and **github.com/Azure** ΓÇö Official repos, issue trackers, samples
6. **azure.status.microsoft** ΓÇö Service health and incident history
7. **developer.microsoft.com** ΓÇö Platform docs, SDKs
...
- 4ΓÇô6 key findings as bullet points summarizing the most impactful patterns
...
Identify and rank the top 6ΓÇô8 issue categories. For each category provide:
...
- The top 3ΓÇô5 pain points based on troubleshooting docs and known issues
...
**Priority 1: Critical Gaps** ΓÇö Table format:

| Service | Documentation Need | Customer Impact | Priority |
|---------|--------------------|-----------------|----------|

**Priority 2: High-Value Content** ΓÇö Bullet list of recommended guides, playbooks, or tutorials that would reduce incident volume.
...
Identify 4ΓÇô6 emerging themes such as:
...
- **Near-term (next 2 quarters)**: 4ΓÇô6 projects for high-value content
...
Summarize 4ΓÇô6 concrete next steps, focusing on:
