...
Load [source-hierarchy.md](../references/source-hierarchy.md) for the complete tiered source authority reference.

For product-area-specific repo lookups, consult [routing-index.md](../sources/routing-index.md) and load the matching category YAML only if you need repo-level detail.
...
See [quality-checklist.md](../references/quality-checklist.md) — verify the fact-check quality section.
